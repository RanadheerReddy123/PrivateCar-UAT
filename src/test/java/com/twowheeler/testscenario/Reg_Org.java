...
import com.twowheeler.base.TestBaseOrg;
...
public class Reg_Org extends TestBaseOrg {
	...
	public void setReport() throws IOException {
		...
		htmlReporter = new ExtentSparkReporter("./reports/PCRVOrg-UAT-Reports.html");
