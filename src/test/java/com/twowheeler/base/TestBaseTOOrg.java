...
public class TestBaseTOOrg {
	...
	public static ExcelReader excel = new ExcelReader(
			System.getProperty("user.dir") + "\\src\\test\\resources\\TestData\\PrivateCarOrg.xlsx");
	...
	public void setup() throws IOException, InterruptedException {
		...
		if(driver==null) {
			  basedata = new FileReader(System.getProperty("user.dir") + "\\src\\test\\resources\\ConfigFiles\\ZTO.Base.Config.Properties"); 
			  loginlogout = new FileReader(System.getProperty("user.dir")+ "\\src\\test\\resources\\ConfigFiles\\Z.Base.Locator.Properties");
			  Locators = new FileReader(System.getProperty("user.dir")+ "\\src\\test\\resources\\ConfigFiles\\TO.Locator.Properties");
	...
	public void write(String result,Method m, int colNum, int rowNum) {
		String excelFilePath = System.getProperty("user.dir") + "\\src\\test\\resources\\TestData\\PrivateCarOrg.xlsx";
		try {
	...
	public String read(String sheetname, int colNum, int rowNum) {
		String excelFilePath = System.getProperty("user.dir")
				+ "\\src\\test\\resources\\TestData\\PrivateCarOrg.xlsx";
		try {
			FileInputStream inputStream = new FileInputStream(new File(excelFilePath));
			Workbook workbook = WorkbookFactory.create(inputStream);
			String data = "";
	...
	@AfterSuite(alwaysRun = true)
	  public void tearDown() throws InterruptedException {
		...
		testDataPath = System.getProperty("user.dir") + "\\src\\test\\resources\\TestData\\PrivateCarOrg.xlsx";

		try {
			//String timestamp = new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss").format(new Date());
			//String repName = "Test-Report-"+timestamp+".html";
			String reportPath = System.getProperty("user.dir") + "\\reports\\PCTOOrg-UAT-Reports.html";
